    ...
    public static class SimpleHttpTest
    {
        public static void Run()
        {
            ...
            var step1 = Step.Create("post_booking_dapr", async context =>
            {
                ...
                var response = await httpClient.PostAsJsonAsync("http://localhost:5003/booking/actor", request, context.CancellationToken);

                //HACK!
                // var response = await httpClient.PostAsJsonAsync(
                //     "http://127.0.0.1:3500/v1.0/actors/BookingMovieActor/adeaaf18-80da-49ae-bf16-83a4ef4783ff/method/Book",
            ...
            var step = Step.Create("post_booking", async context =>
            {
                ...
                var response = await httpClient.PostAsJsonAsync("http://localhost:5003/booking", request, context.CancellationToken);
